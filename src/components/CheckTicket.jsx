        ...
        <div className="check-ticket">
            ...
            {ticketInfo && (
                <><div className='QR-image'>
                    <img src={`https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=${barcode}`} alt="QR Code" />
                </div>
            ...
            <div className="button-container">
                <button onClick={startScan}>Start QR Scanner</button>
            ...
            {scan && <QRScanner onScan={(code) => { setBarcode(code); stopScan(); }} />}
        </div>
    );
}
